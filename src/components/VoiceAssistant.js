...
const VoiceAssistant = () => {
 ...
 icon: Volume2,
 classes:
 "bg-gray-400/15 border border-stone-300/40 text-gray-100 shadow-[0_0_20px_rgba(200,200,200,0.2)]",
 };
 }
 ...
 <div className="w-1 h-1 rounded-full bg-stone-50" />
 <div className="w-1 h-1 rounded-full bg-stone-50" />
 </div>
 <div
 className={`bg-stone-50 rounded-full transition-all duration-150 ${isSpeaking ? "w-2.5 h-1" : "w-2 h-0.5"}`}
 />
 </div>
 </motion.div>
 ...
 className={`h-12 w-12 rounded-xl border flex items-center justify-center transition-colors ${
 isSpeaking
 ? "bg-stone-1000/20 border-stone-300/45 text-gray-100"
