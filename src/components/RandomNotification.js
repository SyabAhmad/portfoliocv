...
const RandomNotification = () => {
 ...
 <div className="w-16 h-16 flex-shrink-0 bg-stone-50/10 rounded-lg flex items-center justify-center overflow-hidden">
 <img
 src={gifUrl}
 alt="Sticker"
 ...
 className="flex-shrink-0 bg-stone-50/20 hover:bg-stone-50/30 text-white rounded-full w-7 h-7 flex items-center justify-center transition-all duration-200"
 >
 ✕
 </button>
 </div>
 ...
 className="h-0.5 bg-stone-50/60"
 />
 </div>
 </motion.div>
 )}
