...
const SimpleChatbot = () => {
 ...
 className="flex-1 border-2 border-stone-300 rounded-full px-3 py-2 sm:px-6 sm:py-3 text-xs sm:text-sm text-gray-800 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-stone-50 transition-all duration-200 font-medium shadow-lg"
 disabled={isTyping}
 />
 <button
 ...
 <div className="bg-stone-50 rounded-lg shadow-xl border border-stone-200 overflow-hidden h-full flex flex-col">
 {/* Header with close button - Fixed */}
 <div className="bg-stone-100 px-3 py-2 sm:px-4 sm:py-3 border-b border-stone-200 flex justify-between items-center flex-shrink-0">
 ...
 <button
 onClick={closePanel}
 className="text-stone-500 hover:text-stone-700 p-1 hover:bg-stone-200 rounded transition-colors"
 >
