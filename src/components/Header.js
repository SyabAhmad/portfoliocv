...
const Header = () => {
 ...
 key={item.path}
 to={item.path}
 className="text-stone-300 hover:text-cyan-400 transition-colors duration-300 font-medium"
 >
 {item.label}
 </Link>
 ))}
 ...
 <button
 type="button"
 className="flex items-center gap-2 text-stone-300 hover:text-cyan-400 transition-colors duration-300 font-medium"
 aria-haspopup="true"
 ...
 className="block px-4 py-2 text-stone-300 hover:text-white hover:bg-slate-800/70 transition text-left"
 >
 Overview
 </Link>
 ...
 <button
 onClick={toggleTheme}
 className="p-2 rounded-full bg-slate-800/50 hover:bg-slate-700/50 text-stone-300 hover:text-cyan-400 transition-all duration-300 mr-4"
 ...
 <button
 onClick={toggleTheme}
 className="p-2 rounded-full bg-slate-800/50 hover:bg-slate-700/50 text-stone-300 hover:text-cyan-400 transition-all duration-300 mr-2"
 aria-label="Toggle theme"
 >
 {theme === "light" ? (
 <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
 ...
 {/* Mobile menu button */}
 <button
 className="lg:hidden text-stone-300 hover:text-cyan-400 transition-colors duration-300"
 ...
 key={item.path}
 to={item.path}
 className="text-stone-300 hover:text-cyan-400 transition-colors duration-300 font-medium py-2"
 ...
 <button
 type="button"
 className="w-full flex items-center justify-between px-4 py-2 text-stone-300 hover:text-white hover:bg-slate-800/70 transition"
 ...
 <Link
 to="/design"
 className="block px-6 py-2 text-sm text-stone-400 hover:text-white hover:bg-slate-800/70 transition"
 onClick={() => {
 setIsMenuOpen(false);
