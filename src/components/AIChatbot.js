...
const AIChatbot = () => {
 ...
 break;
 case 'code':
 elements.push(<code key={i} className="bg-stone-100 text-red-600 px-1 py-0.5 rounded text-xs font-mono">{currentElement}</code>);
 break;
 case 'h1':
 elements.push(<h1 key={i} className="text-lg font-bold text-gray-800 mt-2 mb-1">{currentElement}</h1>);
 break;
 case 'h2':
 elements.push(<h2 key={i} className="text-base font-bold text-stone-700 mt-2 mb-1">{currentElement}</h2>);
 break;
 case 'h3':
 elements.push(<h3 key={i} className="text-sm font-bold text-stone-600 mt-1 mb-1">{currentElement}</h3>);
 break;
 case 'li':
 elements.push(<div key={i} className="ml-4 text-stone-700">{currentElement}</div>);
 break;
 default:
 ...
 <div className="text-xs text-stone-300 mt-1">Smart Portfolio Assistant</div>
 ...
 {/* Chat Window */}
 {isOpen && (
 <div className="fixed bottom-6 right-6 w-[420px] h-[650px] bg-stone-50 rounded-3xl shadow-2xl z-50 flex flex-col overflow-hidden border-2 border-purple-200">
 ...
 <div className="w-12 h-12 bg-stone-50/20 rounded-full flex items-center justify-center backdrop-blur-sm border-2 border-white/30">
 ...
 className="hover:bg-stone-50/20 p-2 rounded-full transition-colors backdrop-blur-sm"
 >
 ...
 {/* Dropdown Menu */}
 {showMenu && (
 <div className="absolute right-0 top-full mt-2 bg-stone-50 rounded-xl shadow-xl border border-stone-200 py-2 w-44 z-20 backdrop-blur-sm">
 <button
 onClick={showStats}
 className="w-full px-4 py-3 text-left text-sm text-stone-700 hover:bg-purple-50 flex items-center space-x-3 transition-all"
 >
 ...
 <div className="text-xs text-stone-600 mb-3 flex items-center font-medium">
 ...
 : message.type === 'system'
 ? 'bg-yellow-100 text-gray-800 border border-stone-200 rounded-bl-md shadow-gray-100'
 : 'bg-stone-50 text-gray-800 border border-stone-200 rounded-bl-md shadow-gray-100'
 }`}>
 ...
 <div className="bg-stone-50 border border-stone-200 px-4 py-4 rounded-2xl rounded-bl-md shadow-lg">
 <div className="flex items-center space-x-3">
 ...
 <span className="text-sm text-stone-500 font-medium">Let me think...</span>
 </div>
 </div>
 ...
 className="w-full resize-none border-2 border-purple-200 rounded-2xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent text-sm max-h-24 bg-stone-50 text-gray-800 placeholder-gray-500"
 disabled={isTyping}
 rows="1"
 ...
 {/* Status bar */}
 <div className="text-xs text-stone-500 mt-3 text-center flex items-center justify-center space-x-2">
