...
const RevitPortfolio = () => {
  ...
  return (
    <div className="min-h-screen pt-24 pb-16 from-gray-50 via-blue-50/20 to-gray-100 dark:from-slate-900 dark:via-blue-900/5 dark:to-slate-900 transition-colors duration-300">
      <div className="container mx-auto px-4 md:px-8 max-w-5xl">
        ...
        >
          <h1 className="text-4xl md:text-5xl font-bold bg-from-blue-600 to-indigo-600 dark:from-blue-400 dark:to-indigo-400 bg-clip-text text-transparent mb-4">
