...
const pinColors = ["bg-rose-700", "bg-stone-1000", "bg-gray-600", "bg-rose-700", "bg-gray-400", "bg-stone-1000", "bg-rose-700"];
...
const Skills = () => {
 ...
 viewport={{ once: true }}
 className="text-3xl md:text-4xl font-bold text-center text-stone-900 mb-12 font-heading"
 ...
 className="relative bg-stone-50 rounded-sm shadow-xl shadow-stone-900/5 p-5 border border-stone-200"
 style={{ transform: `rotate(${rot}deg)` }}
 >
 {/* Tape strip */}
 <div
 className="absolute -top-2.5 left-[20%] w-16 h-5 bg-stone-200 rounded-sm shadow-sm"
 style={{ transform: `rotate(${-rot * 1.5}deg)` }}
 />

 {/* Pushpin */}
 <div className={`absolute -top-1.5 right-[15%] w-3 h-3 ${pinColor} rounded-full shadow border border-stone-900/10 z-10`} />
 ...
 <h3 className="text-stone-900 font-bold text-sm font-handwriting">
 {category.title}
 </h3>
 </div>
 ...
 <span
 key={skillIndex}
 className="px-2.5 py-1 bg-stone-100 border border-stone-200 rounded-full text-xs text-stone-700 font-handwriting"
 >
 {skill}
 </span>
 ))}
 ...
 >
 <p className="text-stone-400 text-sm font-handwriting" style={{ transform: "rotate(1deg)" }}>
