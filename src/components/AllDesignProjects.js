    ...
    <div className="min-h-screen pt-24 pb-16 bg-white dark:bg-slate-900 transition-colors duration-300">
      <div className="container mx-auto px-4 md:px-8 max-w-6xl">
        ...
        >
          ...
          <div className="absolute top-0 right-0 w-48 h-48 bg-blue-500/8 rounded-full blur-3xl -translate-y-1/2 translate-x-1/3" />
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-4 mb-10">
            ...
            {categories.map((cat) => (
              <button
                ...
                className={`px-4 py-2 rounded-lg text-sm font-medium transition-all duration-300 ${
                  filter === cat
                    ? "bg-gray-800 text-white shadow-lg shadow-gray-500/25"
          ...
          <select
            ...
            className="px-4 py-2 bg-white dark:bg-slate-800 text-gray-700 dark:text-gray-300 border border-gray-200 dark:border-slate-700 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-gray-500/30"
          >
        ...
        >
          <AnimatePresence mode="popLayout">
            {filteredProjects.map((project) => (
              ...
              >
                <div
                  className={`h-1 bg-${categoryColors[project.category] || "from-gray-800 to-gray-600"} opacity-0 group-hover:opacity-100 transition-opacity duration-500`}
                />
                ...
                <div className="p-5">
                  <div className="flex items-start justify-between mb-2">
                    ...
                    <span className={`px-2 py-0.5 rounded-full text-[10px] font-medium text-white bg-${categoryColors[project.category] || "from-gray-800 to-gray-600"} flex-shrink-0 ml-2`}>
                      {project.category}
                    </span>
                  </div>
