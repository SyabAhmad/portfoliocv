...
const Research = () => {
  ...
  const researchToShow = showAllResearch
    ? validResearchIdeas
    : validResearchIdeas.slice(0, 6);

  // If no research data, show a message
  if (validResearchIdeas.length === 0) {
    return (
      <div className="min-h-screen p-8 pt-24 bg-gradient-to-br from-gray-50 via-purple-50 to-gray-100 dark:from-slate-900 dark:via-purple-900 dark:to-slate-900 transition-colors duration-300">
        <div className="container mx-auto text-center">
          <h1 className="text-5xl font-bold bg-gradient-to-r from-emerald-600 to-cyan-600 dark:from-emerald-400 dark:to-cyan-400 bg-clip-text text-transparent mb-12">
            Research & Ideas
          </h1>
    ...
    <>
      ...
      <div className="min-h-screen p-8 pt-24 bg-gradient-to-br from-gray-50 via-purple-50 to-gray-100 dark:from-slate-900 dark:via-purple-900 dark:to-slate-900 transition-colors duration-300">
        <div className="container mx-auto">
          <h1 className="text-5xl font-bold text-center bg-gradient-to-r from-emerald-600 to-cyan-600 dark:from-emerald-400 dark:to-cyan-400 bg-clip-text text-transparent mb-12">
            Research & Ideas
          </h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {researchToShow.map((research, index) => {
              ...
              return (
                <div
                  key={index}
                  className="bg-gradient-to-br from-white/90 to-gray-100/90 dark:from-gray-800/90 dark:to-gray-900/90 backdrop-blur-sm border border-gray-200 dark:border-gray-700/50 rounded-xl shadow-2xl p-6 transition-all duration-300 hover:-translate-y-2 hover:shadow-emerald-500/20 hover:border-emerald-500/50"
                >
                    ...
                    <div className="text-sm">
                      ...
                      <div className="flex flex-wrap gap-1 mt-1">
                        {(research.techniques || []).map((technique, idx) => (
                          <span
                            key={idx}
                            className="px-2 py-1 bg-purple-100 text-purple-700 border border-purple-200 dark:bg-purple-500/20 dark:text-purple-300 text-xs rounded dark:border-purple-500/30"
                          >
                            {technique}
                          </span>
                        ))}
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
              ...
              <div className="text-center">
                <div className="text-3xl font-bold text-yellow-600 dark:text-yellow-400 mb-2">
                  {
                    validResearchIdeas.filter(
                      (r) => getResearchStatus(r.title) === "Planning"
                    ).length
                  }
                </div>
                <div className="text-gray-600 dark:text-gray-300 text-sm">
