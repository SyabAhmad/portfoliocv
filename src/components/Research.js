...
const Research = () => {
 ...
 return (
 <div className="min-h-screen p-8 pt-24 bg-black transition-colors duration-300">
 <div className="container mx-auto text-center">
 <h1 className="text-4xl font-bold text-white mb-12 font-handwriting">Research & Ideas</h1>
 <div className="bg-black border border-stone-200 rounded-sm p-8">
 ...
 className="text-4xl md:text-5xl font-bold text-white mb-3 font-handwriting"
 ...
 activeDomain === domain
 ? "bg-stone-900 text-stone-50 dark:text-stone-900 shadow-lg"
 : "bg-black/50 text-stone-400 hover:bg-stone-700 hover:text-stone-300"
 }`}
 >
 {domain}
 </button>
 ...
 >
 {/* Tape */}
 <div className="absolute -top-2.5 left-[15%] w-14 h-5 bg-stone-200 rounded-sm shadow-sm z-10" style={{ transform: `rotate(${-rot * 2}deg)` }} />
 {/* Pin */}
 <div className={`absolute -top-1.5 right-[12%] w-2.5 h-2.5 ${pinColor} rounded-full shadow border border-stone-900/20 z-10`} />

 <div className="relative bg-stone-50 rounded-sm border border-stone-200 shadow-lg transition-all duration-300 overflow-hidden hover:shadow-xl hover:shadow-stone-900/5">
 <div className="p-5">
 {/* Status + domain badge */}
 <div className="flex items-center justify-between mb-3">
 <span className={`px-2.5 py-1 text-xs font-medium rounded-full font-handwriting ${
 status === "Worked On"
 ? "bg-rose-700/20 text-rose-300 border border-rose-700/30"
 ...
 {/* Title */}
 <h3 className="text-base font-bold text-stone-900 mb-3 leading-snug font-handwriting">
 {research.title}
 </h3>

 {/* Description */}
 <p className="text-stone-600 text-xs leading-relaxed mb-4 line-clamp-3 font-handwriting">
 {research.description}
 </p>

 {/* Domain */}
 <div className="text-xs text-stone-500 mb-3 font-handwriting">
 <span className="font-bold text-stone-600">{research.domain}</span>
 </div>

 {/* Techniques */}
 <div className="flex flex-wrap gap-1.5 mb-3">
 {(research.techniques || []).slice(0, 3).map((tech, idx) => (
 <span key={idx} className="px-2 py-0.5 bg-stone-100 border border-stone-300 rounded-full text-[10px] text-stone-600 font-handwriting">
 {tech}
 </span>
 ))}
 ...
 className="inline-flex items-center gap-2 px-6 py-2.5 bg-stone-900 text-stone-50 dark:text-stone-900 font-semibold rounded-full hover:shadow-lg transition-all duration-300 font-handwriting text-sm"
 >
 ...
 <div className="bg-stone-50 rounded-sm border border-stone-200 shadow-lg p-6 md:p-8">
 <h3 className="text-xl font-bold text-stone-900 mb-6 text-center font-handwriting">
 Research Overview
 </h3>
 ...
 { label: "Total Ideas", value: stats.total, color: "text-white", rotate: -0.5 },
 ...
 className="bg-stone-100 border border-stone-300 rounded-sm p-4 text-center relative"
 style={{ transform: `rotate(${stat.rotate}deg)` }}
 >
 <div className="absolute -top-1.5 left-1/2 -translate-x-1/2 w-2 h-2 bg-rose-700 rounded-full shadow-sm border border-rose-900 z-10" />
