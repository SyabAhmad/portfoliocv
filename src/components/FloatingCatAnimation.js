...
const FloatingCatAnimation = () => {
 ...
 className="absolute -top-12 left-1/2 transform -translate-x-1/2 bg-stone-50 dark:bg-gray-800 px-4 py-2 rounded-full shadow-lg border-2 border-cyan-400 whitespace-nowrap"
 >
 ...
 {/* Message tail */}
 <div className="absolute -bottom-2 left-1/2 transform -translate-x-1/2 w-3 h-3 bg-stone-50 dark:bg-gray-800 border-b-2 border-r-2 border-cyan-400 rotate-45"></div>
 </motion.div>
