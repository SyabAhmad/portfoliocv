...
const Avatar3DTailwind = ({
 ...
 >
 <div
 className={`w-3 h-3 rounded-full bg-stone-50 shadow-lg transition-all duration-150 ${
 ...
 animate={{ scale: 1 }}
 exit={{ scale: 0 }}
 className={`${avatarSizes.mouthNeutral} bg-stone-50 rounded-full`}
 />
 )}
 {getMouthShape() === "open" && (
 <motion.div
 ...
 animate={{ scale: 1 }}
 exit={{ scale: 0 }}
 className={`${avatarSizes.mouthClosed} bg-stone-50 rounded-full`}
 />
 )}
 </AnimatePresence>
 </div>
